...
def processRequest(req):
    ...
    elif req.get("result").get("action") == "getd3":
	data = req
	res = makeWebhookResultFord3(data)  
    elif req.get("result").get("action") == "getinfinityLabs":
	data = req
	res = makeWebhookResultForinfinityLabs(data) 
    elif req.get("result").get("action") == "getBooth":
	data = req
	res = makeWebhookResultForBooth(data) 
    ...
    elif req.get("result").get("action") == "getBye":
	data = req
...
def makeWebhookResultForGetBye(data):
...
def makeWebhookResultForinfinityLabs(data):
    speech = 'Please get help from an UST Global employee to connect to the wifi.'
    return {
	"speech": speech,
	"displayText": speech,
